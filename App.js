    ...
    <View style={{ flex: 1 }}>
      ...
      <NavigationContainer>
        <MainNavigator.Navigator screenOptions={{ headerShown: false }}>
          ...
          />
          <MainNavigator.Screen
            name="UpcomingErrands"
            component={UpcomingErrands}
          />
          <MainNavigator.Screen
            name="UpcomingHirerErrands"
            component={UpcomingHirerErrands}
          />
          <MainNavigator.Screen
            name="OngoingErrands"
            component={OngoingErrands}
          />
          ...
          <MainNavigator.Screen
            ...
            component={SharingLocation}
          />
          <MainNavigator.Screen
            name="ViewHirerProfile"
            component={ViewHirerProfile}
          />
          ...
          <MainNavigator.Screen
            ...
            component={VerificationFeedback}
          />
